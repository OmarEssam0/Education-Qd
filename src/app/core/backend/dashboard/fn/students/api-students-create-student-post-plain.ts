...
export interface ApiStudentsCreateStudentPost$Plain$Params {
      body?: EducationApplicationUseCasesStudentsCreateStudentCommandCreateStudentCommand
}

export function apiStudentsCreateStudentPost$Plain(http: HttpClient, rootUrl: string, params?: ApiStudentsCreateStudentPost$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<EducationApplicationUseCasesStudentsCreateStudentCommandCreateStudentResponse>> {
  const rb = new RequestBuilder(rootUrl, apiStudentsCreateStudentPost$Plain.PATH, 'post');
  if (params) {
...
apiStudentsCreateStudentPost$Plain.PATH = '/api/Students/CreateStudent';
